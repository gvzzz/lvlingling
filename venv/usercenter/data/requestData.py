...
report_url_service = "http://shark.ymmoa.com/#/report/report?report_type=suite"  #按照服务维度查询报告的url
result_url_service = "http://shark.ymmoa.com/api/show/status?report_type=suite" #按照服务维度查询报告的url
