...
class auto_registe_driver_qa_Test(unittest.TestCase):
    def test_auto_registe_driver(self):
        ...
        # 第二步开始走提交司机的资料
        driverAuthenticate_path = '../data/driverAuthenticate_dev.json'
        ...
        shipper_approve_path = "../data/driverauditpass_dev.json"
        ...
        # 第四步开始行驶证信息 并且AI审核通过
        submitVehicleLicense_path = '../data/submitVehicleLicense_dev.json'
