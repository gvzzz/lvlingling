...
def getAllAuthItem(env_url,path):
    request_url = env_url+ data.requestData.getAllAuthItem_request
...
if __name__ == '__main__':
    ...
    path = "../data/getAllAuthItem_dev.json"
    getAllAuthItem(env_url,path)