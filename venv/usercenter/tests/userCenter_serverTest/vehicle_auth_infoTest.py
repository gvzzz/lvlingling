...
def qa_vehicle_auth_info(i):
    ...
    diapatch_url = "http://192.168.206.110:8080/mobile/vehicle/auth-info"
...
def writeExcelDaliy(openList,closeList,inputIsSameList,difList):
    ...
    myWorkbook.save(today +"vehicle_auth_info"+"dev"+ '.xls')
